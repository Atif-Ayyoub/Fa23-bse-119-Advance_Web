                ...
                <div class="w-100 h-100 mx-0 row row-cols-2 bg-dark">
                    <div class="col-8 h-100 pb-2 d-flex flex-column">
                        ...
                        <div class="flex-grow-1 d-flex flex-column bg-light bg-opacity-50">
                            <div class="form-group py-2 d-flex border-bottom align-items-center">
                                ...
                                <div class="col-auto">
                                    ...
                                    ?>
                                    <select id="category-filter" class="form-select form-select-sm rounded-0">
                                        <option value="all">All Categories</option>
                                        <?php while($c = $cat_qry->fetch_assoc()): ?>
...
<script>
    $(function(){
        function filterList(){
            ...
            var _cat = $('#category-filter').val()
            $('#plist tbody tr').each(function(){
                var _text = $(this).text().toLowerCase()
                var cname = $(this).find('.pname').text()
                var show = true
                if(_search && !_text.includes(_search)) show = false
                if(_cat && _cat != 'all' && cname != _cat) show = false
                $(this).toggle(show)
            })
        }
